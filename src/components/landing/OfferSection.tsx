              ...
              <div className="p-6 bg-primary/5 rounded-2xl border border-primary/20 mt-8">
                <div className="flex items-start gap-4">
                  ...
                  <div className="flex-1">
                    <h4 className="font-semibold text-foreground mb-2">Alpha IA : votre pocket coach (disponible 24h/24)</h4>
                    <p className="text-sm text-muted-foreground mb-3">
                      Alpha IA vous aide en 2 à 5 minutes à retrouver du calme, clarifier votre prochain choix, appliquer 3R sur
