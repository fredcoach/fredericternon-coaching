      ...
      <div className="container mx-auto px-4">
        ...
        >
          ...
          <p className="text-2xl font-semibold mb-8">
            Tu as besoin de décider mieux — depuis un{" "}
            <span className="text-accent">état stable</span>.
          </p>
          ...
          <div className="flex items-center justify-center gap-3 text-primary-foreground/70">
            ...
            <p className="text-sm">
              ou envoie-moi <strong className="text-primary-foreground">"CADRAGE"</strong> en DM
            </p>
          </div>
