      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        >
          ...
          <p className="text-2xl font-semibold mb-8">
            Vous mérites de vous sentir <span className="text-accent">légitime, serein et puissant</span>.
          </p>

          <p className="text-primary-foreground/80 mb-10">
            Sans sacrifier qui vous êtes. Sans porter tout. Sans t'épuiser en silence.
          </p>
